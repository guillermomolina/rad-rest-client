...
class CmdKstat:
    ...
    def init_parser(subparsers):
        ...
        parser = subparsers.add_parser(CmdKstat.name,
                                       aliases=CmdKstat.aliases,
                                       parents=[parent_parser],
                                       formatter_class=argparse.ArgumentDefaultsHelpFormatter,
                                       description='Manage kstat statistics',
                                       help='Manage kstat statistics')
        ...
        for subcommand in CmdKstat.commands:
